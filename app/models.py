...
class Sprzet(db.Model):
    ...
    temperatura_aktualna: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(10, 6))
    ...
    temperatura_max: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(10, 6), server_default=text("'120.00'"))
    ...
    temperatura_docelowa: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(10, 6), comment='Temperatura zadana przez operatora')
...
class OperatorTemperatures(db.Model):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    id_sprzetu: Mapped[int] = mapped_column(Integer)
    temperatura: Mapped[decimal.Decimal] = mapped_column(DECIMAL(10, 6))
