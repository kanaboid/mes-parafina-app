...
from sqlalchemy import Column, DECIMAL, DateTime, ForeignKeyConstraint, Index, Integer, JSON, String, TIMESTAMP, Table, Text, text
...
t_log_uzyte_segmenty = Table(
    'log_uzyte_segmenty', Base.metadata,
    Column('id_operacji_log', Integer, primary_key=True, nullable=False),
    Column('id_segmentu', Integer, primary_key=True, nullable=False),
